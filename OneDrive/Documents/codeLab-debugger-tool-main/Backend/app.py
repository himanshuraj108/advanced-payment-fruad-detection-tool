...
def correct_code_using_mistral(code):
    try:
        ...
        payload = {
            "model": "mistral-medium",
            "messages": [
                {"role": "system", "content": "only give corrected code without any html formatting and css classes and without any other text and without any other text"},
                {"role": "user", "content": f"only give corrected code without any html formatting and css classes and without any other text and without any other text:\n\n{code}"}
            ]
        }
