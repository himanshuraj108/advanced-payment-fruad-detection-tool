...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape' && featuresPopup.style.display === 'flex') {
            hideFeaturePopup();
        }
    });
...
function analyzeCodeForNavigation() {
    ...
    const variables = varMatches.map(match => {
            ...
            <div id="autocomplete-tab" class="tab-content">
                ...
                <div class="autocomplete-preview">
                    ...
                    <div class="preview-content">
                        ...
                        <span class="code-line active">    total += item.price * <span class="autocomplete-suggestion">item.quantity</span></span>
